...
The dataset I have selected shows the number of TB cases per age group, divided by sex, for 201 countries in the year 2000. This data were taken from a [Udemy R course](https://www.udemy.com/course/r-programming-for-statistics-and-data-science/) I did, and was originally sourced from WHO, likely [this report](https://iris.who.int/server/api/core/bitstreams/e031e926-f850-4d6d-a99f-d6ae841add4b/content).
...
```{r}
tb <- read_csv("tb_untidy.csv") # I had to store this data in /Users/User/Documents/GIT/reproducible-research because R wouldn't read from the "data" folder
